...
.multiple_comparisons <- function(index,
  ...
  error = function(cond){
    ...
    if(save_perm_stats){
      ...
      list(result_df = data.frame("comparison" = paste0(comparison_info[1], ": ", comparison_info[2], " v.s. ", comparison_info[3])),
           perm_values = data.frame("comparison" = paste0(comparison_info[1], ": ", comparison_info[2], " v.s. ", comparison_info[3])))
